...
import type { SidebarProps } from '~/components/Sidebar/Sidebar.vue'

interface SidebarMobileProps extends SidebarProps {
  isOpen: boolean
}

const props = defineProps<SidebarMobileProps>()
      ...
      <div class="fixed inset-0 flex">
        ...
        >
          <DialogPanel class="relative mr-16 flex w-full max-w-xs flex-1">
            ...
            <div
              class="
                flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6 pb-2
